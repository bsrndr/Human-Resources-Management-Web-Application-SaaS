...
{
    public class CreateEmployeeVmMetaData
    {
        ...
        [Range(1.00, double.MaxValue, ErrorMessage = "Salary must be greater than 0.")][RegularExpression(@"^\d+(\.\d{1,2})?$", ErrorMessage = "Invalid salary format. For example: 12345.67")] 
